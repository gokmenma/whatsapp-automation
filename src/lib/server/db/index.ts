...
function ensureUserSettingsColumns() {
    sqlite.exec(`
        CREATE TABLE IF NOT EXISTS user_settings (
            ...
            account_rotation_enabled INTEGER NOT NULL DEFAULT 0,
            account_rotation_message_count INTEGER NOT NULL DEFAULT 1,
            message_delay INTEGER NOT NULL DEFAULT 2000,
            batch_size INTEGER NOT NULL DEFAULT 25,
            batch_wait_minutes INTEGER NOT NULL DEFAULT 5,
            use_message_delay INTEGER NOT NULL DEFAULT 1,
            use_batch_size_limit INTEGER NOT NULL DEFAULT 1,
            use_batch_wait INTEGER NOT NULL DEFAULT 1,
    ...
    const requiredColumns: Array<[string, string]> = [
        ...
        ['account_rotation_enabled', 'ALTER TABLE user_settings ADD COLUMN account_rotation_enabled INTEGER NOT NULL DEFAULT 0'],
        ['account_rotation_message_count', 'ALTER TABLE user_settings ADD COLUMN account_rotation_message_count INTEGER NOT NULL DEFAULT 1'],
        ...
        ['use_message_delay', 'ALTER TABLE user_settings ADD COLUMN use_message_delay INTEGER NOT NULL DEFAULT 1'],
        ['use_batch_size_limit', 'ALTER TABLE user_settings ADD COLUMN use_batch_size_limit INTEGER NOT NULL DEFAULT 1'],
        ['use_batch_wait', 'ALTER TABLE user_settings ADD COLUMN use_batch_wait INTEGER NOT NULL DEFAULT 1'],
